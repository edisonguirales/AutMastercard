...
import com.mastercard.lts.rewards.pwrautomation.utils.PerfectoLabUtils;
...
public final class WindTunnelUtils {
     ...
     * Example:
     * pointOfInterest(DriverConfiguration, "Login Successful", WindTunnelUtils.SUCCESS);
     */
     ...
     * Example:
     * reportTimer(DriverConfiguration, loginScreenTimer, 5000, "Timer for login screen", "");
     */
